...
public class VariablesandElements {
	//LOG-IN VARIABLES
	   protected String WEBSITE = new String("https://phoenix_epod_app.dice205.asia/");
	   protected String USERFIELDS = new String("//input[@name='username']");
	   ...
	   protected String USERADMIN = new String("qadice205@gmail.com");
	   protected String PASSADMIN = new String("P@ssw0rd123");
